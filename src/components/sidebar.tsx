...
const sections = [
  {
    label: "Principal",
    items: [
      { href: "/dashboard", label: "Visão Geral", icon: LayoutDashboard, adminOnly: false },
    ],
  },
  {
    label: "Canais",
  ...
  },
  {
    label: "Planejamento",
    items: [
      { href: "/dashboard/planning", label: "Eng. Reversa", icon: Calculator, adminOnly: false },
    ],
  },
];
      ...
      {activeWorkspace && (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            {workspaces.length > 1 && (
              <p className="text-[9px] text-white/25 leading-none mt-0.5">Trocar workspace</p>
            )}
          </div>
